    ...
    <div class="login_box">
      ...
      <form>
        ...
        <ValidatedInput label="邮箱" id="email" v-model="email" placeholder="邮箱"
                        ...
                        @on-validate="handleOnValidate" />
        <ValidatedInput label="电话（可选）" id="phone" v-model="phone" placeholder="电话"
                        :clearable="true" :validate="validatePhone"
                        @on-validate="handleOnValidate" />
        <ValidatedInput label="姓名（可选）" id="name" v-model="name" placeholder="姓名"
                        :clearable="true" />
        <div class="mb-2">
          ...
          <ValidatedInput label="密码" id="password" v-model="password" placeholder="密码"
                          :clearable="true" :validate="validatePassword"
                          @on-validate="handleOnValidate" :show-password="true" />
          <ValidatedInput label="确认密码" id="confirmPassword" v-model="confirmPassword"
                          placeholder="确认密码" :clearable="true"
