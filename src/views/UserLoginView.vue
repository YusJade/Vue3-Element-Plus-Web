    ...
    <div class="login_box">
      ...
      <form>
        ...
        <div style="margin-bottom: 1rem;">
          <el-input v-model="username" :focus="onUsernameInputFocus"
                    v-on:blur="onInputBlur" size="large" type="username"
                    placeholder="您的用户名" clearable="true" />
        </div>
        <div style="margin-bottom: 1rem; position: relative;">
          <el-input v-model="password" :focus="onPasswordInputFocus"
                    v-on:blur="onInputBlur" size="large" type="password"
                    placeholder="您的密码" clearable="true" show-password="true" />
        </div>
        <div style="display: flex; align-items: center; margin-bottom: 1rem;">
          ...
          <div style="display: flex; text-align: right;">
            <a href="#"
               style="right: 0; font-size: 0.875rem; color: #4a5568; transition: color 0.3s;">忘记密码了吗?</a>
          </div>
        </div>
        <div
          ...
          <span v-show="firefiyLookingUsername"
                style="right: 0; display: flex; align-items: center; padding-right: 0.75rem;">
            <img src="../assets/username.png" style="height: 100px;" alt="Show Password">
          </span>
          <span v-show="firefiyLookingPassword"
                style="right: 0; display: flex; align-items: center; padding-right: 0.75rem;">
            <img src="../assets/password.png" style="height: 100px;" alt="Show Password">
          </span>
          <span v-show="firefiyLookingLogin"
                style="right: 0; display: flex; align-items: center; padding-right: 0.75rem;">
            <img src="../assets/looking_login.png" style="height: 100px;"
                 alt="Show Password">
          </span>
        </div>
        <button type="button" @onmouseover="onSubmitBtnHover" @click="onLoginBtnClick"
